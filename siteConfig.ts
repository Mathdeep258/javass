...
export const siteConfig = {
  // 1. 网站标题与博主信息
  title: "LinFan的个人网页",
  faviconUrl: "https://pub-765df429105042d8a0d2a68ac29453aa.r2.dev/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20260531183359_194_3.jpg",
  authorName: "LinFan",
  bio: "要开科学上网要开科学上网要开科学上网，重要事情说三遍",
  ...
  // 修改这里：变成图片数组
  bgImages: ["/bg/bg-1.webp", "/bg/bg-2.webp", "/bg/bg-3.webp", "/bg/bg-4.webp", "/bg/bg-5.webp"],
  ...
  gitalkConfig: {
    clientID: "Ov23liGbquqM7JC1HMi3",
    clientSecret: "6c8ca4cc5dfda909830d83d8dc35f05b211bea8d",
    repo: "blog-comments",
    owner: "Mathdeep258",
    admin: ["Mathdeep258"],
  },
  buildDate: "2026-08-25T20:30:00", // 建站日期
